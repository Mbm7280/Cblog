package com.cblog.modules.ums.controller;


import cn.hutool.core.collection.CollUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.cblog.common.api.ResultApi;
import com.cblog.common.api.ResultApiPage;
import com.cblog.modules.ums.dto.UmsAdminLoginParam;
import com.cblog.modules.ums.dto.UmsAdminParam;
import com.cblog.modules.ums.dto.UpdateAdminPasswordParam;
import com.cblog.modules.ums.model.UmsAdmin;
...
public class UmsAdminController {
    ...
    @ResponseBody
    public ResultApi<ResultApiPage<UmsAdmin>> list(@RequestParam(value = "keyword", required = false) String keyword,
                                                   @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                   @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        Page<UmsAdmin> adminList = adminService.list(keyword, pageSize, pageNum);
        return ResultApi.success(ResultApiPage.restPage(adminList));
    }
    ...
    @ResponseBody
    public ResultApi updateStatus(@PathVariable Long id,@RequestParam(value = "status") String status) {
